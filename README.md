...
* https://docs.unidata.ucar.edu/netcdf-java/5.3/userguide/index.html
...
https://docs.unidata.ucar.edu/netcdf-java/5.3/userguide/ncml_overview.html
...
* https://docs.unidata.ucar.edu/tds/5.3/userguide/basic_client_catalog.html
...
To build netCDF-java from this repository, follow [this tutorial](https://docs.unidata.ucar.edu/netcdf-java/5.3/userguide/building_from_source.html).

To use the netCDF-Java library as a dependency using maven or gradle, follow [these instructions](https://docs.unidata.ucar.edu/netcdf-java/5.3/userguide/using_netcdf_java_artifacts.html).
