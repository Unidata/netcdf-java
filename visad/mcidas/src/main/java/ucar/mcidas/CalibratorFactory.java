...
public final class CalibratorFactory {
   ...
   */
  public final static Calibrator getCalibrator(final int id, final int[] cal) throws CalibratorException {
   ...
   *         sensor is unknown.
   */
  public final static Calibrator getCalibrator(final int id, final int srcType, final int[] cal)
