...
public class AreaDirectory implements java.io.Serializable {
  ...
  private String memo;
  private String[] sensors = {"Derived Data", "Test Patterns", "Graphics", "Miscellaneous", "PDUS Meteosat visible",
      "PDUS Meteosat infrared", "PDUS Meteosat water vapor", "Radar", "Miscellaneous Aircraft Data", "Raw Meteosat",
      "Composite image", "Topography image", "GMS visible", "GMS infrared", "ATS 6 visible", "ATS 6 infrared",
      "SMS-1 visible", "SMS-1 infrared", "SMS-2 visible", "SMS-2 infrared", "GOES-1 visible", "GOES-1 infrared",
      "GOES-2 visible", "GOES-2 infrared", "GOES-3 visible", "GOES-3 infrared", "GOES-4 visible (VAS)",
      "GOES-4 infrared and water vapor (VAS)", "GOES-5 visible (VAS)", "GOES-5 infrared and water vapor (VAS)",
      "GOES-6 visible", "GOES-6 infrared", "GOES-7 visible, Block 1 supplemental data", "GOES-7 infrared", "FY-2B",
      "FY-2C", "FY-2D", "FY-2E", "FY-2F", "FY-2G", "FY-2H", "TIROS-N (POES)", "NOAA-6", "NOAA-7", "NOAA-8", "NOAA-9",
      "Venus", "Voyager 1", "Voyager 2", "Galileo", "Hubble space telescope", "MSG-1", "MSG-2", "MSG-3", "Meteosat-3",
      "Meteosat-4", "Meteosat-5", "Meteosat-6", "Meteosat-7", "", "NOAA-10", "NOAA-11", "NOAA-12", "NOAA-13", "NOAA-14",
      "NOAA-15", "NOAA-16", "NOAA-17", "NOAA-18", "NOAA-19", "GOES 8 imager", // 70
      "GOES 8 sounder", "GOES 9 imager", "GOES 9 sounder", "GOES 10 imager", "GOES 10 sounder", "GOES 11 imager",
      "GOES 11 sounder", "GOES 12 imager", "GOES 12 sounder", "ERBE", "", "GMS-4", "GMS-5", "GMS-6", "GMS-7", "GMS-8",
      "DMSP F-8", "DMSP F-9", "DMSP F-10", "DMSP F-11", "DMSP F-12", "DMSP F-13", "DMSP F-14", "DMSP F-15", // 94
      "FY-1B", "FY-1C", "FY-1D", "", "", "", "TERRA L1B", // 101
      "TERRA CLD", "TERRA GEO", "TERRA-AER", "", "TERRA TOP", "TERRA ATM", "TERRA GUE", "TERRA RET", "", "AQUA L1B", // 111
      "AQUA CLD", "AQUA GEO", "AQUA AER", "", "AQUA TOP", "AQUA ATM", "AQUA GUE", "AQUA RET", "", // 120
      "", "", "", "", "", "", "", "", "", "", // 130
      "", "", "", "", "", "", "", "", "", "", // 140
      "", "", "", "", "", "", "", "", "", "", // 150
      "", "", "", "", "", "", "", "", "", "TERRA NDVI", // 160
      "TERRA CREF", "", "", "", "", "", "", "", "", "AQUA NDVI", // 170
      "AQUA CREF", "", "", "", "", "", "", "", "", "GOES 13 imager", // 180
      "GOES 13 sounder", "GOES 14 imager", "GOES 14 sounder", "GOES 15 imager", "GOES 15 sounder", "GOES 16 imager",
      "GOES 16 sounder", "", // 188
      "", "", // 190
      "", "", "", "", "DMSP F-16", // 195
      "DMSP F-17", "", "", "", // 199
      ...
      "North Pole Composites", "", "", "", "", "", "", "", "", "Megha-Tropiques", // 410
      ""};
  ...
  public AreaDirectory(int[] dirblock) throws AreaFileException {
    ...
    nominalTime = new Date(1000 * McIDASUtil.mcDayTimeToSecs(dir[AreaFile.AD_IMGDATE], dir[AreaFile.AD_IMGTIME]));

    if (dir[AreaFile.AD_STARTDATE] == 0 && dir[AreaFile.AD_STARTTIME] == 0)
      startTime = nominalTime;
    else
      startTime = new Date(1000 * McIDASUtil.mcDayTimeToSecs(dir[AreaFile.AD_STARTDATE], dir[AreaFile.AD_STARTTIME]));
    ...
    for (int i = 0; i < 64; i++) { // band bits in two consequtive words
      ...
      if ((bandmask & dir[AreaFile.AD_BANDMAP + (i / 32)]) == bandmask) {
        ...
        j++;
        if (j >= numbands)
          break; // done, one way or the other...
      }
    ...
    srcTypeOrig =
        (dir[AreaFile.AD_SRCTYPEORIG] == 0) ? srcType : McIDASUtil.intBitsToString(dir[AreaFile.AD_SRCTYPEORIG]).trim();
    calTypeUnit = (dir[AreaFile.AD_CALTYPEUNIT] == 0 || dir[AreaFile.AD_CALTYPEUNIT] == McIDASUtil.MCMISSING) ? null
        : McIDASUtil.intBitsToString(dir[AreaFile.AD_CALTYPEUNIT]).trim();
    // System.out.println("AD.calTypeUnit = >"+calTypeUnit+"<");
    if (calTypeUnit != null && calTypeUnit.equals(""))
      calTypeUnit = null;
    calTypeScaleFactor =
        (dir[AreaFile.AD_CALTYPESCALE] == 0 || dir[AreaFile.AD_CALTYPESCALE] == McIDASUtil.MCMISSING) ? 1
            : dir[AreaFile.AD_CALTYPESCALE];
  }
  ...
  public boolean equals(Object o) {
    ...
    return (this == that || java.util.Arrays.equals(getDirectoryBlock(), that.getDirectoryBlock()));
  }
  ...
  public String toString() {
    ...
    buf.append("  ");
    buf.append(sdf.format(nominalTime, new StringBuffer(), new FieldPosition(0)).toString());
    buf.append("  ");
