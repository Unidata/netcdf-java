 ...
 * <tr>
 * <td><b>C1W3</b></td>
 * <td colspan="2">C1 * W^3</td>
 * </tr>
 * <tr>
 * <td></td>
 * <td>C1 = 2.0e5 * P * C^2</td>
 * <td>radiance/(cm^-1)^3)</td>
 * </tr>
 * <tr>
 * <td></td>
 * <td>W = 1.0e2 * (band wave numbers)</td>
 * <td>(cm^-1)</td>
 * </tr>
 * <tr>
 * <td><b>C2W</b></td>
 * <td colspan="2">C2 * W</td>
 * </tr>
 * <tr>
 * <td></td>
 * <td>C2 = P * C / B</td>
 ...
 * <tr>
 * <td><b>ALPHA</b></td>
 * <td colspan="2">gain adjustment</td>
 * </tr>
 * <tr>
 * <td><b>BETA</b></td>
 * <td colspan="2">bias adjustment</td>
 * </tr>
 * <tr>
 * <td><b>GAIN</b></td>
...
public class CalibratorMsg implements Calibrator {
  ...
  private final float[] bandCoefs = new float[] {21.21f, 23.24f, 19.77f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 22.39f};
   ...
   */
  public float[] calibrate(final float[] input, final int band, final int calTypeOut) {
   ...
   *         calibration type cannot be performed for the specified band.
   */
  public float calibrate(final float inputPixel, final int band, final int calTypeOut) {
    float pxl;
   ...
   *         calibration type cannot be performed for the specified band.
   */
  public float calibrateFromRaw(final float inputPixel, final int band, final int calTypeOut) {
    ...
    if (band < 4 || band == 12) {
      ...
      switch (calTypeOut) {
        case CAL_TEMP: // temperature
          if (pxl > 0) {
            pxl = (coefs[C2W] / Math.log(1.0 + coefs[C1W3] / pxl) - coefs[BETA]) / coefs[ALPHA];
          }
          break;
  ...
  private double[][] getCalCoefs() throws CalibratorException {
    ...
    for (int i = 0; i < coefs.length; i++) {
      ...
      String[] strVals = getBandVals(new String(calBytes, bandOffset, BAND_SIZE));
