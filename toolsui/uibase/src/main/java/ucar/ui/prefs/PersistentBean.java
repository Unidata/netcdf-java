    ...
    PropertyMap(Class<?> beanClass) {
      ...
      for (PropertyDescriptor prop : pds) {
        ...
        if ((prop.getReadMethod() != null)) { // && (prop.getWriteMethod() != null)) {
          ...
          if (debugBeanParser)
            System.out.println(" read/write property " + prop.getName() + " " + propClass.getName() + " prim= "
                + propClass.isPrimitive());
      ...
      if (debugBeanParserDetail) {
        ...
        for (PropertyDescriptor pd : pds) {
          ...
          System.out
              .println("  " + name + " " + type.getName() + " read= " + rm + " write= " + wm + " " + pd.isPreferred());
