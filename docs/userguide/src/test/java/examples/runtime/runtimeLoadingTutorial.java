...
public class runtimeLoadingTutorial {
    ...
    public static void registerIOSP(String classNameAsString) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ucar.nc2.NetcdfFiles.registerIOProvider( classNameAsString);
    }

    public static void registerCoordSystemBuilder(String conventionNameAsString, String classNameAsString) throws ClassNotFoundException {
        ucar.nc2.internal.dataset.CoordSystemFactory.registerConvention( conventionNameAsString, classNameAsString );
    }

    public static void registerCoordTransBuilder(String transformNameAsString, String classNameAsString) throws ClassNotFoundException {
        ucar.nc2.internal.dataset.CoordTransformFactory.registerTransform(  transformNameAsString,  classNameAsString);
    }

    public static void registerFeatureDatasetFactory(FeatureType featureType, String classNameAsString)  {
        ucar.nc2.ft.FeatureDatasetFactoryManager.registerFactory( featureType, classNameAsString);
    }

    public static void registerGRIBTable(int centerAsInt, int subcenterAsInt, int tableVersionAsInt, String yourFileNameAsString) {
        ucar.nc2.grib.grib1.tables.Grib1ParamTables.addParameterTable( centerAsInt,  subcenterAsInt,  tableVersionAsInt,  yourFileNameAsString);
    }
