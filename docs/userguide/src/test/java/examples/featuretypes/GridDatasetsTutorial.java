...
public class GridDatasetsTutorial {
  ...
  public static void gridFormat(String yourLocationAsString, Formatter errlog)
      throws java.io.IOException {
    GridDataset gds =
        ucar.nc2.grid.GridDatasetFactory.openGridDataset(yourLocationAsString, errlog);
  }

  public static void usingGridDataset(String yourLocationAsString, Formatter errlog)
      throws java.io.IOException {
    GridDataset gds =
        ucar.nc2.grid.GridDatasetFactory.openGridDataset(yourLocationAsString, errlog);
  ...
  public static void readingData(GridSubset subsetAsGridSubset, Grid yourGrid)
