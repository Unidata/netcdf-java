...
The netCDF-Java library implements a [Common Data Model (CDM)](../developer/cdm_overview.html){:target="_blank"}, a generalization of the netCDF, OpenDAP and HDF5 data models.
