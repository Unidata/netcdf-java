...
For an overview, see: [CDM Object Model](/thredds/cdm/current/index.html){:target="_blank"}. The Coordinate Axes for a Variable must use a subset of the Variables's dimensions.
