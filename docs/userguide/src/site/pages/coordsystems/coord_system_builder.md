...
For more details, see the [CDM Object Model](../cdm/index.html){:target="_blank"}.
...
You may find it easier to do the same thing using an [NcML](../ncml/index.html){:target="_blank"} file, for example:
