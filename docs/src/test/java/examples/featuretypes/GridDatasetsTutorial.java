...
public class GridDatasetsTutorial {
    ...
    public static void readingData(GridDatatype yourGridDatatype, int time_index, int z_index, int x_index, int y_index) throws IOException {
        // get 2D data at timeIndex, levelIndex
        Array data = yourGridDatatype.readDataSlice(time_index, z_index, x_index, y_index);
    }
    public static void CallMakeSubset(GridDatatype yourGridDatatype, Range rt_range, Range ens_range, Range t_range, Range z_range, Range y_range, Range x_range) throws InvalidRangeException {
        GridDatatype subset = yourGridDatatype.makeSubset(rt_range, ens_range,  t_range, z_range, y_range, x_range);
