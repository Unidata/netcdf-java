...
* https://www.unidata.ucar.edu/projects/THREDDS/tech/catalog/InvCatalogSpec.html[THREDDS
Catalog 1.0 Specification]
* https://www.unidata.ucar.edu/software/netcdf-java/formats/DataDiscoveryAttConvention.html[NetCDF
