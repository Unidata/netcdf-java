...
collections of
https://www.unidata.ucar.edu/software/netcdf-java/reference/FeatureDatasets/Overview.html[CDM
Feature Datasets]. Currently this is used mostly for
https://www.unidata.ucar.edu/software/netcdf-java/tutorial/GridDatatype.html[gridded
