...
* https://www.unidata.ucar.edu/software/netcdf/ncml/FmrcAggregation.html[FMRC
Aggregation]
...
See https://www.unidata.ucar.edu/software/netcdf/ncml/Tutorial.html[NcML
...
2.  If the dataset is
https://www.unidata.ucar.edu/software/netcdf/ncml/Aggregation.html#dynamic[dynamic]
