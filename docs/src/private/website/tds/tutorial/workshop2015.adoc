 ...
 * link:https://www.unidata.ucar.edu/software/thredds/current/tds/tutorial/BasicThreddsConfig_xml.html[Exercise]:
 ...
 *** link:https://www.unidata.ucar.edu/software/thredds/current/netcdf-java/documentation.htm[netCDF-Java] (and thus the TDS)
