...
https://www.unidata.ucar.edu/software/netcdf/ncml/[NcML]. The NcML file
...
However, the dataset must only use the https://www.unidata.ucar.edu/software/netcdf/#fv18[classic model].
* *datasetOut* will be overwritten
* *isLargeFile="true"* will write a https://www.unidata.ucar.edu/software/netcdf/#fv1[64-bit offset netCDF-3 file].
