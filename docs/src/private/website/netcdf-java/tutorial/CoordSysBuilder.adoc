...
https://www.unidata.ucar.edu/software/netcdf/docs/conventions.html[existing
...
https://www.unidata.ucar.edu/software/netcdf/docs/BestPractices.html[Writing
...
https://www.unidata.ucar.edu/software/netcdf/docs/conventions.html[NetCDF
Conventions page].
...
https://www.unidata.ucar.edu/software/netcdf/ncml/[NcML] file, for
example:
...
https://www.unidata.ucar.edu/software/netcdf/ncml/[Here] is complete info
on NcML.
