...
public class MessageUncompressedArrayReader {
   ...
   */
  Array<StructureData> readEntireMessage(Structure s, Message proto, Message m, RandomAccessFile raf, Formatter f)
      throws IOException {
    ...
    StructureMembers.Builder members = s.makeStructureMembersBuilder();
  ...
  private Array<StructureData> makeArraySequenceUncompressed(DebugOut out, BitReader reader,
