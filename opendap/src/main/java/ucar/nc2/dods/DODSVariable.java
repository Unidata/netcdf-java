...
public class DODSVariable extends ucar.nc2.Variable implements DODSNode {
  ...
  DODSVariable(DODSNetcdfFile dodsfile, Group parentGroup, Structure parentStructure, String dodsShortName,
      opendap.dap.BaseType dodsScalar, DodsV dodsV) {
    super(dodsfile, parentGroup, parentStructure, DODSNetcdfFile.makeShortName(dodsShortName));
    setDODSName(DODSNetcdfFile.makeDODSName(dodsShortName));
    this.dodsfile = dodsfile;
  ...
  DODSVariable(DODSNetcdfFile dodsfile, Group parentGroup, Structure parentStructure, String dodsShortName,
      DArray dodsArray, opendap.dap.BaseType elemType, DodsV dodsV) {

    // name is already properly decoded: super(dodsfile, parentGroup, parentStructure, DODSNetcdfFile.makeNetcdfName(
    // dodsShortName));
