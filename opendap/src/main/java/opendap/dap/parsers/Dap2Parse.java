...
public abstract class Dap2Parse {
  ...
  void tagparse(Dap2Parse parsestate, int kind) throws ParseException {
  ...
  Object datasetbody(Dap2Parse state, Object name, Object decls) throws ParseException {
    if (ddsobject == null)
  ...
  Object attributebody(Dap2Parse state, Object attrlist) throws ParseException {
    try {
      if (dasobject == null)
  ...
  void errorbody(Dap2Parse state, Object code, Object msg, Object ptype, Object prog) throws ParseException {
  ...
  void unrecognizedresponse(Dap2Parse state) throws ParseException {
    errorbody(state, "0", state.lexstate.text, null, null);
  }

  Object declarations(Dap2Parse state, Object decls, Object decl) throws ParseException {
  ...
  Object arraydecls(Dap2Parse state, Object arraydecls, Object arraydecl) throws ParseException {
  ...
  Object arraydecl(Dap2Parse state, Object name, Object size) throws ParseException {
    int value;
    DArrayDimension dim;
    try {
  ...
  Object attrlist(Dap2Parse state, Object attrlist, Object attrtuple) throws ParseException {
  ...
  Object attrvalue(Dap2Parse state, Object valuelist, Object value, Object etype) throws ParseException {
  ...
  Object attribute(Dap2Parse state, Object name, Object values, Object etype) throws ParseException {
    Attribute att;
  ...
  Object attrset(Dap2Parse state, Object name, Object attributes) throws ParseException {
    try {
  ...
  Object makebase(Dap2Parse state, Object name, Object etype, Object dimensions) throws ParseException {
    BaseType node;
  ...
  Object makestructure(Dap2Parse state, Object name, Object dimensions, Object fields) throws ParseException {
    BaseType node;
    String dupname;
  ...
  Object makesequence(Dap2Parse state, Object name, Object members) throws ParseException {
    DSequence node;
    String dupname;
  ...
  Object makegrid(Dap2Parse state, Object name, Object arraydecl0, Object mapdecls0) throws ParseException {
    DGrid node;
  ...
  int dapsemanticerror(Dap2Parse state, int kind, String msg) throws ParseException {
    return daperror(state, msg);
  }

  int daperror(Dap2Parse state, String msg) throws ParseException {
    dap_parse_error(state, msg);
    return 0;
  }

  void dap_parse_error(Dap2Parse state, String fmt, Object... args) throws ParseException {
