...
public class MrmsLocalTables extends LocalTables {
  ...
  private void init() {
    ...
    add(209, 9, 0, "ConusMergedReflectivityQC", "WSR-88D 3D Reflectivity Mosaic - 33 CAPPIS (500-19000m)", "dBZ", -999,
        -99);
    add(209, 9, 1, "ConusPlusMergedReflectivityQC", "All Radar 3D Reflectivity Mosaic - 33 CAPPIS (500-19000m)", "dBZ",
        -999, -99);
    add(209, 10, 0, "MergedReflectivityQCComposite", "Composite Reflectivity Mosaic (optimal method)", "dBZ", -999,
        -99);
    ...
    add(209, 10, 3, "HeightLowLevelCompositeReflectivity",
        "Height of Low-Level Composite Reflectivity Mosaic (0-4km) MSL", "m", -3, -1);
    ...
    add(209, 10, 5, "LayerCompositeReflectivity_High",
        "Layer Composite Reflectivity Mosaic 24-60 kft (highest altitude)", "dBZ", -999, -99);
    add(209, 10, 6, "LayerCompositeReflectivity_Super",
        "Layer Composite Reflectivity Mosaic 33-60 kft (super high altitude)", "dBZ", -999, -99);
