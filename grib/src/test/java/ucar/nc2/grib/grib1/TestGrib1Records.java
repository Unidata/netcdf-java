...
public class TestGrib1Records {
  ...
  public static List<Object[]> getTestParameters() {
    ...
    result
        .add(new Object[] {"afwa.grib1", 0, 61, 16899, CalendarDate.parseISOformat("ISO8601", "2005-05-04T00:00:00Z")});
    result.add(
        new Object[] {"ECMWF.grib1", 0, 129, 1681, CalendarDate.parseISOformat("ISO8601", "2006-12-25T12:00:00Z")});
    result.add(
        new Object[] {"HPPI89_KWBC.grib1", 0, 2, 5329, CalendarDate.parseISOformat("ISO8601", "2010-03-31T18:00:00Z")});
    result.add(
        new Object[] {"thinGrid.grib1", 0, 11, 5329, CalendarDate.parseISOformat("ISO8601", "2005-07-27T12:00:00Z")});
    result.add(new Object[] {"airtmp_zht_000002_000000_1a0061x0061_2010011200_00240000_fcstfld.grib1", 1, 11, 3721,
        CalendarDate.parseISOformat("ISO8601", "2010-01-12T00:00:00Z")});
    result.add(new Object[] {"radar_national.grib1", 3, 201, 400000,
        CalendarDate.parseISOformat("ISO8601", "2005-01-20T02:15:00Z")});
    ...
    result.add(new Object[] {"complex_packing.grib1", 4, 122, 131072,
        CalendarDate.parseISOformat("ISO8601", "2015-11-09T00:00:00Z")});
    ...
    result.add(new Object[] {"D2.2006091400.F012.002M.CLWMR.grib1", 5, 153, 102960,
        CalendarDate.parseISOformat("ISO8601", "2006-09-14T00:00:00Z")});
    result.add(new Object[] {"noaaRFC-QPE.grib1", 5, 237, 157500,
        CalendarDate.parseISOformat("ISO8601", "2010-10-05T00:00:00Z")});
    result.add(new Object[] {"rotatedlatlon.grib1", 10, 7, 176904,
        CalendarDate.parseISOformat("ISO8601", "2003-12-15T18:00:00Z")});
    result.add(new Object[] {"ncepPredefinedGds.grib1", 21000, 100, 37 * 36,
        CalendarDate.parseISOformat("ISO8601", "2004-11-19T00:00:00Z")});
