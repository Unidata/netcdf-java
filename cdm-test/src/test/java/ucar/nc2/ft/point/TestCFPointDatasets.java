...
public class TestCFPointDatasets {
  ...
  public static List<Object[]> getStationProfileDatasets() {
    ...
    result
        .add(new Object[] {CFpointObs_topdir + "stationProfileMultidimUnlimited.nc", FeatureType.STATION_PROFILE, 18});
    result.add(new Object[] {CFpointObs_topdir + "stationProfileMultidimJoinZ.ncml", FeatureType.STATION_PROFILE, 24});
    result
        .add(new Object[] {CFpointObs_topdir + "stationProfileMultidimJoinTime.ncml", FeatureType.STATION_PROFILE, 18});
    result.add(
        new Object[] {CFpointObs_topdir + "stationProfileMultidimJoinTimeAndZ.ncml", FeatureType.STATION_PROFILE, 36});
    result.add(
        new Object[] {CFpointObs_topdir + "stationProfileMultidimMissingId.ncml", FeatureType.STATION_PROFILE, 27});
    result.add(new Object[] {CFpointObs_topdir + "stationProfileMultidimMissingIdString.ncml",
        FeatureType.STATION_PROFILE, 27});
    result.add(
        new Object[] {CFpointObs_topdir + "stationProfileMultidimMissingTime.ncml", FeatureType.STATION_PROFILE, 16});
    result.add(
        new Object[] {CFpointObs_topdir + "stationProfileMultidimMissingAlt.ncml", FeatureType.STATION_PROFILE, 15});
  ...
  public static List<Object[]> getSectionDatasets() {
    ...
    result.add(
        new Object[] {CFpointObs_topdir + "sectionMultidimMissingIdString.ncml", FeatureType.TRAJECTORY_PROFILE, 100});
    result
        .add(new Object[] {CFpointObs_topdir + "sectionMultidimMissingTime.ncml", FeatureType.TRAJECTORY_PROFILE, 28});
