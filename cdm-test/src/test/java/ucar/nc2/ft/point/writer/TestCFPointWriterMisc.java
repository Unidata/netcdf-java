...
public class TestCFPointWriterMisc {
  ...
  public void testProfileInnerTime() throws Exception {
    ...
    try (FeatureDatasetPoint pods = (FeatureDatasetPoint) FeatureDatasetFactoryManager
      ...
      try (FeatureDatasetPoint rewrite =
          rewriteDataset(pods, "nc", new CFPointWriterConfig(NetcdfFileWriter.Version.netcdf3))) {
  ...
  public void testAltUnits() throws Exception {
    ...
    try (FeatureDatasetPoint pods = (FeatureDatasetPoint) FeatureDatasetFactoryManager
      ...
      FeatureDatasetPoint rewrite =
          rewriteDataset(pods, "nc4", new CFPointWriterConfig(NetcdfFileWriter.Version.netcdf4));
      collectionList = rewrite.getPointFeatureCollectionList();
      DsgFeatureCollection fc2 = collectionList.get(0);
  ...
  public void testPointZCoord() throws Exception {
    ...
    Formatter buf = new Formatter();
    try (FeatureDatasetPoint fdpoint = (FeatureDatasetPoint) FeatureDatasetFactoryManager
        .open(ucar.nc2.constants.FeatureType.POINT, file, null, buf)) {
      ...
      FeatureDatasetPoint rewrite =
          rewriteDataset(fdpoint, "nc3", new CFPointWriterConfig(NetcdfFileWriter.Version.netcdf3));
      collectionList = rewrite.getPointFeatureCollectionList();
