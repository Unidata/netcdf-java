...
public class TestDtWithCoverageReadingSingleP {
  ...
  public static List<Object[]> getTestParameters() {
    ...
    // Slice Mixed_layer_depth_surface runtime=2009-11-22T00:00:00Z (0) ens=0.000000 (-1) time=2009-11-23T00:00:00Z (0)
    // vert=0.000000 (-1)
    ...
    // Slice Momentum_flux_u-component_surface_Mixed_intervals_Average runtime=2015-03-01T12:00:00Z (2) ens=0.000000
    // (-1) time=2015-03-04T19:30:00Z (26) vert=0.000000 (-1)
    result.add(new Object[] {TestDir.cdmUnitTestDir + "gribCollections/gfs_2p5deg/gfs_2p5deg.ncx4", FeatureType.GRID,
        "Momentum_flux_u-component_surface_Mixed_intervals_Average", "2015-03-01T12:00:00Z", null,
        "2015-03-04T19:30:00Z", null, null});

    // Slice Total_ozone_entire_atmosphere_single_layer runtime=2015-03-01T12:00:00Z (2) ens=0.000000 (-1)
    // time=2015-03-03T15:00:00Z (17) vert=0.000000 (-1)
    result.add(new Object[] {TestDir.cdmUnitTestDir + "gribCollections/gfs_2p5deg/gfs_2p5deg.ncx4", FeatureType.GRID,
        "Total_ozone_entire_atmosphere_single_layer", "2015-03-01T12:00:00Z", null, "2015-03-03T15:00:00Z", null,
        null});
    //
    // Slice runtime=2015-03-01T00:00:00Z (0) ens=0.000000 (-1) time=2015-03-06T19:30:00Z (46) vert=0.000000 (-1)
    result.add(new Object[] {TestDir.cdmUnitTestDir + "gribCollections/gfs_2p5deg/gfs_2p5deg.ncx4", FeatureType.GRID,
        "Momentum_flux_u-component_surface_Mixed_intervals_Average", "2015-03-01T00:00:00Z", null,
        "2015-03-06T19:30:00Z", null, 46});

    // Test Dataset Q:/cdmUnitTest/gribCollections/gfs_2p5deg/gfs_2p5deg.ncx4 Grid
    // TwoD/Total_ozone_entire_atmosphere_single_layer
    // Slice runtime=2015-03-01T06:00:00Z (1) ens=0.000000 (-1) time=2015-03-01T00:00:00Z (0) vert=0.000000 (-1)
    result.add(new Object[] {TestDir.cdmUnitTestDir + "gribCollections/gfs_2p5deg/gfs_2p5deg.ncx4", FeatureType.GRID,
        "Total_ozone_entire_atmosphere_single_layer", "2015-03-01T06:00:00Z", null, "2015-03-01T12:00:00Z", null,
        null});
    // Slice runtime=2015-03-01T06:00:00Z (1) ens=0.000000 (-1) time=2015-03-01T03:00:00Z (1) vert=0.000000 (-1)
    result.add(new Object[] {TestDir.cdmUnitTestDir + "gribCollections/gfs_2p5deg/gfs_2p5deg.ncx4", FeatureType.GRID,
        "Total_ozone_entire_atmosphere_single_layer", "2015-03-01T12:00:00Z", null, "2015-03-01T12:00:00Z", null,
        null});
    // Slice runtime=2015-03-01T18:00:00Z (3) ens=0.000000 (-1) time=2015-03-17T18:00:00Z (92) vert=30000.000000 (9)
    result.add(new Object[] {TestDir.cdmUnitTestDir + "gribCollections/gfs_2p5deg/gfs_2p5deg.ncx4", FeatureType.GRID,
        "Total_ozone_entire_atmosphere_single_layer", "2015-03-01T18:00:00Z", null, "2015-03-17T18:00:00Z", null,
        null});
    ...
    result.add(new Object[] {
        ...
        "Relative_humidity_sigma_layer", "2015-03-26T06:00:00Z", null, "2015-03-26T06:00:00Z", 0.580000, null}); // SRC
                                                                                                                 // //
                                                                                                                 // TP
    result.add(new Object[] {
        TestDir.cdmUnitTestDir + "gribCollections/tp/GFS_Global_onedeg_ana_20150326_0600.grib2.ncx4", FeatureType.GRID,
        "Relative_humidity_sigma_layer", "2015-03-26T06:00:00Z", null, "2015-03-26T06:00:00Z", 0.665000, null}); // SRC
                                                                                                                 // //
                                                                                                                 // TP
    result.add(new Object[] {
        TestDir.cdmUnitTestDir + "gribCollections/tp/GFS_Global_onedeg_ana_20150326_0600.grib2.ncx4", FeatureType.GRID,
        "Absolute_vorticity_isobaric", "2015-03-26T06:00:00Z", null, "2015-03-26T06:00:00Z", 100000.0, null}); // SRC //
                                                                                                               // TP
