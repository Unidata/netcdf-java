...
public class TestRdaReading {
  ...
  /*
   * 2016-02-25T16:09:29 [1341825] [47] INFO threddsServlet: (184.96.199.251)
   * /thredds/cdmrfeature/grid/aggregations/g/ds083.2/2/Best?
   ...
   * at ucar.nc2.grib.collection.PartitionCollectionImmutable$VariableIndexPartitioned.getDataRecord(
   * PartitionCollectionImmutable.java:684) ~[grib-5.0.0-SNAPSHOT.jar:5.0.0-SNAPSHOT]
   * at ucar.nc2.grib.collection.GribDataReader.readDataFromPartition2(GribDataReader.java:223)
   * ~[grib-5.0.0-SNAPSHOT.jar:5.0.0-SNAPSHOT]
   * at ucar.nc2.grib.collection.GribDataReader.readData2(GribDataReader.java:192)
   * ~[grib-5.0.0-SNAPSHOT.jar:5.0.0-SNAPSHOT]
   * at ucar.nc2.grib.coverage.GribCoverageDataset.readData(GribCoverageDataset.java:1278)
   * ~[grib-5.0.0-SNAPSHOT.jar:5.0.0-SNAPSHOT]
