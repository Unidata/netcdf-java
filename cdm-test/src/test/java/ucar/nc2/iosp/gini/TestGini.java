...
public class TestGini {
  ...
  public static Collection giniFiles() {
    Object[][] data =
        new Object[][] {{"n0r_20041013_1852-compress", "Reflectivity", 4736, 3000, -120.0, -80.190548, 23.0, 50.391550},
            ...
            {"HI-NATIONAL_10km_SOUND-6.51_20050918_1824.gini", "sounder_imagery", 1472, 1073, 109.9999, -109.1284,
                -25.0004, 60.6914},
            ...
            {"SUPER-NATIONAL_1km_SFC-T_20050912_1900.gini", "SFC_T", 1536, 1008, -141.0274, -32.417681, 7.8381,
                79.760853},
  ...
  public TestGini(String fname, String varName, int nx, int ny, double min_lon, double max_lon, double min_lat,
      double max_lat) {
    this.fname = fname;
