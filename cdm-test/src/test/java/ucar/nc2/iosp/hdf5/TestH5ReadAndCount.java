...
public class TestH5ReadAndCount {
  ...
  public static List<Object[]> getTestParameters() {
    ...
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/AVAFO_NPP_d2003125_t10109_e101038_b9_c2005829155458_devl_Tst.h5",
            0, 7, 12, 51, 0, 4});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/GDNBF-VNCCO_NPP_d2003125_t101038_e10116_b9_c2005829162517_dev.h5",
            0, 24, 16, 104, 0, 6});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/GIMFT-VIVIO_NPP_d2003125_t101038_e10116_b9_c2005829173243_dev.h5",
            0, 20, 16, 98, 0, 6});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/GMOFT-VOCCO_NPP_d2003125_t101038_e10116_b9_c2005829163632_dev.h5",
            0, 41, 16, 134, 0, 6});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/GMOFT-VSSTO_NPP_d2003125_t101038_e10116_b9_c2005829165313_dev.h5",
            0, 25, 16, 109, 0, 6});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/RVIRS_NPP_d2003125_t101038_e10116_b9_c200582917556_devl_Tst.h5", 0,
            3, 8, 26, 0, 4});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/SVI01-GIMFG_NPP_d2003125_t101038_e10116_b9_c2005829153351_dev.h5",
            0, 29, 15, 116, 0, 6});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/SVM04-GMOFG_NPP_d2003125_t101038_e10116_b9_c2005829171444_dev.h5",
            0, 29, 15, 116, 0, 6});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/VI1BO_NPP_d2003125_t101038_e10116_b9_c2005829155954_devl_Tst.h5",
            0, 6, 12, 43, 0, 4});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/VI2BO_NPP_d2003125_t101038_e10116_b9_c2005829165919_devl_Tst.h5",
            0, 6, 12, 43, 0, 4});
    result.add(
        new Object[] {testDir + "npoess/ExampleFiles/VLSTO-GMOFT_NPP_d2003125_t102618_e102646_b9_c2005830184722_de.h5",
            0, 23, 16, 106, 0, 6});

    result.add(new Object[] {testDir + "IASI/IASI_xxx_1C_M02_20070704193256Z_20070704211159Z_N_O_20070704211805Z.h5", 0,
        28, 0, 790, 674, 10});
    result.add(new Object[] {testDir + "IASI/IASI.h5", 0, 28, 0, 777, 661, 10});

    result.add(
        new Object[] {testDir + "aura/OMI-Aura_L3-OMTO3e_2005m1214_v002-2006m0929t143855.he5", 2, 4, 20, 28, 0, 7});
    ...
    // EOS Swaths
    result.add(new Object[] {testDir + "aura/OMI-Aura_L2-OMTO3_2007m0624t1616-o15646_v002-2007m0625t152428.he5", 5, 44,
        21, 342, 0, 8});
  ...
  public TestH5ReadAndCount(String filename, int ndims, int nvars, int ngatts, int natts, int nstructFields,
      int ngroups) {
  ...
  public void test() throws IOException {
    try (NetcdfFile ncfile = NetcdfFile.open(filename)) {
      ...
      if (false) {
        ...
        System.out.println("result.add(new Object[]{testDir+\"" + filename + "\"," + c.ndims + "," + c.nvars + ","
            + c.ngatts + "," + c.natts + "," + c.nstructFields + "," + c.ngroups + ");");
        ncfile.close();
        return;
      }
