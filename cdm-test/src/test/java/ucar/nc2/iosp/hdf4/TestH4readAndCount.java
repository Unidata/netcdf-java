...
public class TestH4readAndCount {
  ...
  public static List<Object[]> getTestParameters() {
    ...
    result.add(
        new Object[] {testDir + "balloon_sonde.o3_knmi000_de.bilt_s2_20060905t112100z_002.hdf", 4, 11, 33, 286, 0, 0});
    ...
    // ---------------Reading directory C:\data\hdf4\ncidc
    result.add(new Object[] {testDir + "ncidc/AMSR_E_L2A_BrightnessTemperatures_V08_200801012345_A.hdf", 26, 101, 48,
        280, 0, 9});
    ...
    result.add(
        new Object[] {testDir + "ssec/2006166131201_00702_CS_2B-GEOPROF_GRANULE_P_R03_E00.hdf", 2, 27, 188, 35, 0, 4});
    result.add(new Object[] {testDir + "ssec/AIRS.2005.08.28.103.L1B.AIRS_Rad.v4.0.9.0.G05241172839.hdf", 9, 216, 284,
        21, 0, 4});
    result
        .add(new Object[] {testDir + "ssec/CAL_LID_L1-Launch-V1-06.2006-07-07T21-20-40ZD.hdf", 112, 59, 2, 164, 22, 0});
  ...
  public TestH4readAndCount(String filename, int ndims, int nvars, int ngatts, int natts, int nstructFields,
      int ngroups) {
  ...
  private void read(String filename, int ndims, int nvars, int ngatts, int natts, int nstructFields, int ngroups)
    ...
    if (false) {
      ...
      filename = StringUtil2.replace(filename, '\\', "/");
      System.out.println("read(testDir+\"" + filename + "\"," + c.ndims + "," + c.nvars + "," + c.ngatts + "," + c.natts
          + "," + c.nstructFields + "," + c.ngroups + ");");
      ncfile.close();
      return;
    }
