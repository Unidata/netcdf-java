...
public class TestGribIndexCreationOther {
  ...
  public void testFireWx() throws IOException {
    FeatureCollectionConfig config =
        new FeatureCollectionConfig("namFirewx", "test/namFirewx", FeatureCollectionType.GRIB2,
            // TestDir.cdmUnitTestDir + "gribCollections/www/.*grib2",
            "B:/lead/namFirewx/.*gbx9", null, null, null, "file", null);
  ...
  public void testRadarNWS() throws IOException {
    ...
    FeatureCollectionConfig config =
        new FeatureCollectionConfig("radarNWS", "test/radarNWS", FeatureCollectionType.GRIB1,
            // TestDir.cdmUnitTestDir + "gribCollections/www/.*grib2",
            "B:/lead/radar/**/.*gbx9", null, null, null, "directory", null);
  ...
  public void testWwwCoastalAlaska() throws IOException {
    ...
    FeatureCollectionConfig config =
        new FeatureCollectionConfig("Coastal_Alaska", "test/Coastal_Alaska", FeatureCollectionType.GRIB2,
            // TestDir.cdmUnitTestDir + "gribCollections/www/.*grib2",
            "B:/idd/WWW/Coastal_Alaska/.*gbx9", null, null, null, "file", null);
  ...
  public void make626inv() throws IOException {
    FeatureCollectionConfig config = new FeatureCollectionConfig("ds626.0.invariants", "test/ds626.0inv",
        FeatureCollectionType.GRIB1, "B:/rdavm/ds6260inv/.*grb$", null, null, null, null, null);
    System.out.printf("config = %s%n", config);
  ...
  public void testRDAds628p1_fcst_surf125_var() throws IOException {
    FeatureCollectionConfig config = new FeatureCollectionConfig("ds628p1_fcst_surf125_var",
        "rdavm/ds628p1_fcst_surf125_var", FeatureCollectionType.GRIB1,
  ...
  public void testRDAds131() throws IOException {
    FeatureCollectionConfig config = new FeatureCollectionConfig("testRDAds131", "rdavm/testRDAds131",
        FeatureCollectionType.GRIB1, "B:/rdavm/ds131.1/sflxfg_mean/.*grib$", null, null, null, null, null);
  ...
  public void testCarlosMoraga() throws IOException {
    FeatureCollectionConfig config = new FeatureCollectionConfig("CarlosMoragaEcmwf", "CarlosMoragaEcmwf",
        FeatureCollectionType.GRIB1, "B:/testdata/support/CarlosMoraga/ECMWF_GNERA.*", null, null, null, null, null);
  ...
  public void testNcdcNarr() throws IOException {
    ...
    config.setFilter("B:/ncdc/0402/home/tomcat/dans-tdm-content/content/tdm/cache/GribIndex/global/nomads/nexus/narr/",
        "\\d{6}/\\d{8}/.*gbx9$");
  ...
  // String olderThan, String timePartition, Element innerNcml
  @Ignore("B: not visible on spock")
  @Test
  ...
  public void testRdvamds093p2() throws IOException {
    FeatureCollectionConfig config = new FeatureCollectionConfig("ds093.2", "test/ds093.2", FeatureCollectionType.GRIB2,
        "D:/work/rdavm/ds093.2/diurnal/.*grb2", null, null, null, "directory", null);
  ...
  public void testRdvamds093p2tar() throws IOException {
    FeatureCollectionConfig config = new FeatureCollectionConfig("ds093.2tar", "test/ds093.2/tar",
        FeatureCollectionType.GRIB2, "D:/work/rdavm/ds093.2/diurnal/.*grb2", null, null, null, "directory", null);
  ...
  public void testRdvamds628p0() throws IOException {
    FeatureCollectionConfig config = new FeatureCollectionConfig("ds628.0_ll125", "test/ds628.0_ll125",
        FeatureCollectionType.GRIB1, "D:/work/rdavm/ds628.0/ll125/**/ll125.*[0-9]{4}$", null, null, null, "none", null);
  ...
  public void testRdvamds628p0fcst_surf() throws IOException {
    FeatureCollectionConfig config =
        new FeatureCollectionConfig("ds628.0_fcst_surf_local", "test/ds628.0_fcst_surf", FeatureCollectionType.GRIB1,
            "D:/work/rdavm/ds628.0/fcst_surf/2012/.*gbx9", null, null, null, "directory", null);
