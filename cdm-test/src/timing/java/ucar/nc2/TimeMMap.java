...
public class TimeMMap {
  ...
  static void writeChannelDirect(String filename, long fileSize, int recordSize, Stat stat) throws Exception {
    ...
    if (debug)
      System.out.println("Opened file to write:'" + rfilename + "', size=" + channel.size() + " fileSize = " + fileSize
          + " Mb; recSize = " + recordSize + " Kb; nrecs = " + n);
  ...
  static long timeReadMMap(String filename, Stat stat) throws Exception {
    ...
    if (showEach || stat == null)
      System.out
          .println("readMM from " + filename + " nbytes= " + pos + " nreads = " + nreads + " took " + diff + " msecs");
  ...
  static long timeReadCD(String filename, Stat stat) throws Exception {
    ...
    if (showEach || stat == null)
      System.out
          .println("readCD from " + filename + " nbytes= " + pos + " nreads = " + nreads + " took " + diff + " msecs");
