...
abstract class CEBisonParser {
  ...
  private int yyaction(int yyn, YYStack yystack, int yylen) throws ParseException {
    ...
    switch (yyn) {
      ...
      case 26:
        ...
        {
          yyval = subslice(3, ((String) (yystack.valueAt(5 - (1)))), ((String) (yystack.valueAt(5 - (5)))),
      ...
      case 34:
        ...
        {
          yyval = predicate(((CEAST.Operator) (yystack.valueAt(3 - (2)))), ((CEAST) (yystack.valueAt(3 - (1)))),
              ((CEAST) (yystack.valueAt(3 - (3)))));
        } ;
        break;
      ...
      case 35:
        ...
        {
          yyval = predicaterange(((CEAST.Operator) (yystack.valueAt(5 - (2)))),
              ((CEAST.Operator) (yystack.valueAt(5 - (4)))), ((CEAST) (yystack.valueAt(5 - (1)))),
              ((CEAST) (yystack.valueAt(5 - (3)))), ((CEAST) (yystack.valueAt(5 - (5)))));
        } ;
        break;
      ...
      case 47:
        ...
        {
          yyval = null;
          dimredef(((String) (yystack.valueAt(3 - (1)))), ((Slice) (yystack.valueAt(3 - (3)))));
        } ;
        break;
  ...
  private static final byte[] yydefgoto_init() {
    return new byte[] {-1, 1, 2, 6, 7, 8, 9, 32, 10, 13, 14, 23, 24, 25, 11, 40, 41, 60, 61, 42, 16, 43, 44};
  }
  ...
  private static final short[] yytoken_number_init() {
    return new short[] {0, 256, 257, 258, 259, 260, 261, 262, 44, 263, 59, 46, 123, 125, 91, 93, 58, 124, 33, 60, 61,
        62, 126, 40, 41};
  }
  ...
  private static final String[] yytname_init() {
    return new String[] {"$end", "error", "$undefined", "NAME", "STRING", "LONG", "DOUBLE", "BOOLEAN", "','", "NOT",
        "';'", "'.'", "'{'", "'}'", "'['", "']'", "':'", "'|'", "'!'", "'<'", "'='", "'>'", "'~'", "'('", "')'",
        "$accept", "constraint", "dimredeflist", "clauselist", "clause", "projection", "segmenttree", "segmentforest",
        "segment", "slicelist", "slice", "subslicelist", "subslice", "index", "selection", "filter", "predicate",
