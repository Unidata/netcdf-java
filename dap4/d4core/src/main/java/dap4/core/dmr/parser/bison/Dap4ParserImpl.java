...
public class Dap4ParserImpl extends Dap4BisonParser implements Dap4Parser {
  ...
  DapAttribute makeAttribute(DapSort sort, String name, DapType basetype, List<String> nslist, DapNode parent)
      throws DapException {
  ...
  List<String> convertNamespaceList(NamespaceList nslist) {
    return nslist;
  }
