...
public class SingleTrajectoryObsDataset extends TypedDatasetImpl implements TrajectoryObsDataset {
  ...
  public static class Config {
    ...
    public Config(String trajectoryId, Dimension timeDim, Variable timeVar, Variable latVar, Variable lonVar,
        Variable elevVar) {
  ...
  private class SingleTrajectory implements TrajectoryObsDatatype {
    ...
    private SingleTrajectory(String id, int numPoints, Variable timeVar, String timeVarUnitsString, Variable latVar,
