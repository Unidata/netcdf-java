 ...
 *
 * <p>
 * The constructor extends the allowed form of a CrawlableDataset path to
 ...
 *
 * <p>
 * This is the default implementation of CrawlableDataset used by
 * CrawlableDatasetFactory if the class name handed to the
 * createCrawlableDataset() method is null.
 * </p>
 *
 * @author edavis
...
public class CrawlableDatasetFile implements CrawlableDataset {
  ...
  public List<CrawlableDataset> listDatasets() throws IOException {
    ...
    if (files == null) {
      log.error("listDatasets(): the underlying file [" + this.file.getPath()
          + "] exists, is a directory, and canRead()==true but listFiles() returns null. This may be a problem Java has on Windows XP (Java 7 should fix).");
