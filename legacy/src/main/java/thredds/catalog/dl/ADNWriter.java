...
public class ADNWriter {
  ...
  public void writeDataset(InvDataset ds, Element rootElem) {
    ...
    metaElem.addContent(new Element("scheme", defNS).addContent(
    ...
    metaElem.addContent(new Element("copyright", defNS)
        .addContent("Copyright (c) 2002 UCAR (University Corporation for Atmospheric Research)"));
    ...
    oreq.addContent(new Element("otherType", defNS)
        .addContent("Requires data viewer tool. See the documentation page in the resource."));
  ...
  protected Element writeGeospatialCoverage(ThreddsMetadata.GeospatialCoverage gc) {
    ...
    geo.addContent(
        new Element("coordinateSystem", defNS).setAttribute("type", "DLESE:Geographic latitude and longitude"));
