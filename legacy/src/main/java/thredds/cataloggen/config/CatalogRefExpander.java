...
public class CatalogRefExpander {
  ...
  public CatalogRefExpander(String name, String directoryMatchPattern, String catalogTitleSubstitutionPattern,
      String catalogFilenameSubstitutionPattern, boolean expand, boolean flattenCatalog) {
    this.name = name;
  ...
  public boolean equals(Object o) {
    ...
    if (flattenCatalog != catalogRefExpander.flattenCatalog)
      return false;
    if (expand != catalogRefExpander.expand)
      return false;
    if (catalogFilenameSubstitutionPattern != null
        ? !catalogFilenameSubstitutionPattern.equals(catalogRefExpander.catalogFilenameSubstitutionPattern)
        : catalogRefExpander.catalogFilenameSubstitutionPattern != null)
      return false;
    if (catalogTitleSubstitutionPattern != null
        ? !catalogTitleSubstitutionPattern.equals(catalogRefExpander.catalogTitleSubstitutionPattern)
        : catalogRefExpander.catalogTitleSubstitutionPattern != null)
      return false;
    if (directoryMatchPattern != null ? !directoryMatchPattern.equals(catalogRefExpander.directoryMatchPattern)
        : catalogRefExpander.directoryMatchPattern != null)
      return false;
    if (name != null ? !name.equals(catalogRefExpander.name) : catalogRefExpander.name != null)
      return false;
  ...
  public int hashCode() {
    ...
    result =
        29 * result + (catalogFilenameSubstitutionPattern != null ? catalogFilenameSubstitutionPattern.hashCode() : 0);
