...
public final class Factor implements Serializable {
  ...
  public boolean equals(final Object object) {
    ...
    if (this == object) {
      ...
      equals = getExponent() == that.getExponent() && (getExponent() == 0 || getBase().equals(that.getBase()));
    }
    return equals;
  }
  ...
  @Override
  public int hashCode() {
    return getExponent() == 0 ? getClass().hashCode() : getExponent() ^ getBase().hashCode();
  }
  ...
  public boolean isReciprocalOf(final Factor that) {
    return getBase().equals(that.getBase()) && getExponent() == -that.getExponent();
  }
