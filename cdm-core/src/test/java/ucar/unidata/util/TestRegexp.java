...
public class TestRegexp {
  ...
  public void testLogMatchFrag1() {
    testOne("^(\\d+-\\d+-\\d+T\\d+:\\d+:\\d+\\.\\d+ [+-]\\d+)", "2015-07-23T21:24:23.760 +0000", true);
  }
  ...
  @Test
  public void test4() {
    testMatch(".*(J.....) (....) .*", "WMO JUBE99 EGRR 030000", true, new String[] {"JUBE99", "EGRR"});
    testMatch(".*([IJ].....) (....) .*", "WMO IUBEs9 sssR 030000", true, new String[] {"IUBEs9", "sssR"});
  }

  @Test
  public void test5() {
    testMatch("(.*)\\(see Note.*", "Software identification (see Note 2)", true,
        new String[] {"Software identification "});
  }
  ...
  private void testOneLine(String line) {
    testMatch("([^\\s]*) ([^\\s]*) ([^\\s]*) ([^\\*-]*) ([^\\s]*)?", line, true, null);
  }
  ...
  public void testGhcnm() {
    ...
    String p =
        "(\\d{11})(\\d{4})TAVG([ \\-\\d]{5})(.)(.)(.)([ \\-\\d]{5})(.)(.)(.)([ \\-\\d]{5})(.)(.)(.)([ \\-\\d]{5})(.)(.)(.)"
            ...
            + "([ \\-\\d]{5})(.)(.)(.)([ \\-\\d]{5})(.)(.)(.)([ \\-\\d]{5})(.)?(.)?(.)?.*";
    testMatch(p, m, true,
        new String[] {"10160355000", "1932", " 1010", " ", " ", "1", "  980", " ", " ", "1", "-9999", " ", " ", " ",
            " 1420", " ", " ", "1", " 1840", " ", " ", "1", "-9999", " ", " ", " ", " 2290", " ", " ", "1", "-9999",
            " ", " ", " ", " 2440", " ", " ", "1", "-9999", " ", " ", " ", "-9999", " ", " ", " ", "-9999", null, null,
            null});
  }
  ...
  public void testGhcnm2() {
    ...
    testMatch(p, m, true, new String[] {"10160355000", "1932", "-9999   ", "-9999", " ", " ", " "});
  }
  ...
  public void testGhcnmStn() {
    ...
    String m =
        "20558362000  31.2000  121.4000    7.0 SHANGHAI            CHINA        23U10980FLxxCO25A 1PADDYLANDS      C";
    String p =
        "(\\d{11}) ([ \\.\\-\\d]{8}) ([ \\.\\-\\d]{9}) ([ \\.\\-\\d]{6}) (.{30}) ([ \\-\\d]{4})(.)([ \\-\\d]{5})(..)(..)(..)([ \\-\\d]{2})(.)(..)(.{16})(.).*";
    testMatch(p, m, true,
        new String[] {"20558362000", " 31.2000", " 121.4000", "   7.0", "SHANGHAI            CHINA     ", "  23", "U",
            "10980", "FL", "xx", "CO", "25", "A", " 1", "PADDYLANDS      ", "C"});
  }
  ...
  public void testIgraStn() {
    ...
    testMatch(p, m, true, new String[] {"JN", "01001", "JAN MAYEN                          ", " 70.93", "  -8.67",
        "   9", "G", "L", " ", "1963", "2007"});
  }
  ...
  public void testIgraPorHead() {
    ...
    testMatch(p, m, true, new String[] {"03091", "1989", "11", "09", "06", "9999", "  11"});
  }
  ...
  public void testIgraPor() {
    ...
    testMatch(p, m, true, new String[] {"20", " 99200", " ", "-9999", " ", "   44", " ", "   48", "-9999", "-9999"});
  }
  ...
  public void testDate() {
    ...
    testMatch(p, m, true, new String[] {"secs", "1997-07-16", "T19:20+01:00", "19:20", "+01:00"});
  }
  ...
  public void testIsoDate2() {
    ...
    testMatch(p, m, true, new String[] {"2012-05-03", " ", "10:03:29", "+03", "+03"});
  }
  ...
  public void testFrag() {
    ...
    String p = "([\\+\\-\\d]+)([ T]([\\.\\:\\d]*)([ \\+\\-]\\S*)?Z?)?$";
    testMatch(p, m, true, new String[] {"2011-02-09", "T06:00:00Z", "06:00:00", null});
  }
  ...
  public void testUdunit() {
    ...
    String p =
        "(\\d*) (\\w*) since ([+-]?[0-9]{1,4})\\-([0-9]{1,2})\\-([0-9]{1,2})[T ]([+-]?[0-9]{1,2}):([0-9]{1,2})(:([0-9]{1,2}))?.*$";
    testMatch(p, m, true, new String[] {"3", "secs", "1991", "01", "01", "03", "12", null, null});
  }
  ...
  public void testNclGrib1Table() {
    ...
    // String p = "\\{(\\d*)\\,\\s*\"([^\"]*)\".*";
    String p = "\\{(\\d*)\\,\\s*\"([^\"]*)\"\\,\\s*\"([^\"]*)\"\\,\\s*\"([^\"]*)\".*";
    testMatch(p, m, true, new String[] {"7", "Geopotential height", "gpm", "ZGEO"});
  }
  /////////////////////////////////////////////////////////
