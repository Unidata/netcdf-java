...
public class TestSection extends TestCase {
  ...
  public void testRange3() throws InvalidRangeException {
    ArrayDouble secA2 =
        (ArrayDouble) A.section(new Section(1 + ":" + (m - 2) + ",0:" + (n - 2) + ",1:" + (p - 1)).getRanges());
  ...
  public void testSectionCopy() throws InvalidRangeException {
    ArrayDouble secA2 =
        (ArrayDouble) A.section(new Section(1 + ":" + (m - 2) + ",0:" + (n - 2) + ",1:" + (p - 1)).getRanges()).copy();
   ...
   * Unfortunately, indexing seems to give me values from the full original array rather than the slice I'm working
   * with.
   * 
   ...
   * 178.0
   * 
   * I would expect the first print statement to print -9999 since that is the first element of the slice I'm working
   * on.
   * So this kind of looks like a bug to me. How do I get the first element of my slice rather than of the entire parent
   * array?
   */
  public void testSlice3D() throws InvalidRangeException, IOException {
    ...
    System.out.println(Ncdump.printArray(a3, "test a3", null));
    Array a2 = a3.slice(0, 1);

    System.out.println(Ncdump.printArray(a2, "a3.slice(0,1)", null));

    Array a1 = a2.slice(0, 1);

    System.out.println(Ncdump.printArray(a1, "a2.slice(0,1)", null));
