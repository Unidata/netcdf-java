...
public class TimingCopy {
  ...
  static public void main(String args[]) throws IOException {
    ...
    // 20000);
    // copyURL2null("http://thredds-dev.unidata.ucar.edu/thredds/fileServer/grib/NCEP/GFS/Global_0p5deg/GFS_Global_0p5deg_20141116_0000.grib2/files/GFS_Global_0p5deg_20141116_0000.grib2",
    // 20000);
    // copyURL2null("http://rdavm.ucar.edu:8080/thredds/fileServer/aggregations/g/ds131.1/4/mean/ds131.1_synop_fgff_mean-1871/files/sflxgrbfg_mean_187101_09.grib",
    // 20000);
    copyURL2null(
        "http://localhost:8080/thredds/fileServer/gribCollection/GFS_2p5/GFS_Global_2p5deg_20150301_0600.grib2/files/GFS_Global_2p5deg_20150301_0600.grib2",
        20000);
    // copyURL2null("http://localhost:8080/thredds/fileServer/gribCollection/GFS_2p5/GFS_Global_2p5deg_20150301_1200.grib2/files/GFS_Global_2p5deg_20150301_1200.grib2",
    // 20000);
    // copyURL2null("http://localhost:8080/thredds/fileServer/gribCollection/GFS_2p5/GFS_Global_2p5deg_20150301_1800.grib2/files/GFS_Global_2p5deg_20150301_1800.grib2",
    // 20000);
    ...
    // copyURL("http://motherlode.ucar.edu:9080/thredds/netcdf/null/dd/RUC2_CONUS_40km_20070709_1800.nc?v,u,Z,T",
    // "C:/temp/null.nc", 10000);

    // copyURL("http://localhost:8080/thredds/netcdf/dd/RUC2_CONUS_40km_20070709_1800.nc?v,u,Z,T", "C:/temp/ruc.nc",
    // 10000);
    // copyURL("http://localhost:8080/thredds/netcdf/stream/dd/RUC2_CONUS_40km_20070709_1800.nc?v,u,Z,T",
    // "C:/temp/rucStream.nc", 10000);
    // copyURL("http://localhost:8080/thredds/netcdf/null/dd/RUC2_CONUS_40km_20070709_1800.nc?v,u,Z,T",
    // "C:/temp/null.nc", 10000);

    // copyURL2null("http://localhost:8080/thredds/netcdf/null/dd/RUC2_CONUS_40km_20070709_1800.nc?v,u,Z,T",
    // "C:/temp/null.nc", 10000);
    // copyURL2null("http://localhost:8080/thredds/netcdf/dd/RUC2_CONUS_40km_20070709_1800.nc?v,u,Z,T",
    // "C:/temp/ruc.nc", 10000);
    // copyURL2null("http://localhost:8080/thredds/netcdf/stream/dd/RUC2_CONUS_40km_20070709_1800.nc?v,u,Z,T",
    // "C:/temp/rucStream.nc", 10000);
    // copyURL2null("http://localhost:8080/thredds/netcdf/null/dd/RUC2_CONUS_40km_20070709_1800.nc?v,u,Z,T",
    // "C:/temp/null.nc", 10000);
    // copyURL("http://localhost:8080/thredds/netcdf/dd/nssl/mosaic3d_nc/tile1/20070803-2300.netcdf?mrefl_mosaic",
    // "C:/temp/netcdf2.nc", 10000);
    // copyURL("http://localhost:8080/thredds/netcdf/stream/dd/nssl/mosaic3d_nc/tile1/20070803-2300.netcdf?mrefl_mosaic",
    // "C:/temp/nsslStream.nc", 10000);
    // copyURL("http://localhost:8080/thredds/netcdf/dd/nssl/mosaic3d_nc/tile1/20070803-2300.netcdf?mrefl_mosaic",
    // "C:/temp/nssl.nc", 10000); // */
  }
  ...
  static public void copyURL2null(String url, int bufferSize) throws IOException {
    ...
    System.out.println(" copyURL2null (" + url + ") took = " + took + " sec; len= " + len + " Mbytes; rate = "
        + Format.d(rate, 3) + " Mb/sec");
  }
  ...
  static public void readURL(String urlString, int bufferSize) throws IOException {
    ...
    try {
      ...
      System.out
          .println(" readURL (" + bufferSize + ") took = " + took + " sec; rate = " + rate + "Mb/sec avg read= " + avg);
