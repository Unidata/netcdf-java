 ...
 * <p>
 * Follows the normal ISO calendar.
 * <p>
...
public final class LeapYearChronology extends AbstractChronology implements Serializable {
   ...
   */
  public final LeapYearDate MIN_DATE = LeapYearDate.of(this, Year.MIN_VALUE, 1, 1);
  /**
   * The maximum supported {@code LeapYearDate}, '+999999999-12-31'.
   * This could be used by an application as a "far future" date.
   */
  public final LeapYearDate MAX_DATE = LeapYearDate.of(this, Year.MAX_VALUE, 12, 31);
  /**
  ...
  public LeapYearDate dateEpochDay(long epochDay) {
    ...
    LeapYearDate result = LeapYearDate.of(this, year, month + 1, dom + 1);
    return result;
  }
   ...
   * LOOK why not return (ChronoLocalDateTime<Uniform30DayDate>) super.localDateTime(temporal);
   * 
   * @param temporal the ChronoLocalDateTime date-time object to convert, not null
   * @return the ChronoLocalDateTime local date-time, not null
   ...
   * // LOOK gettig converted to Instant
