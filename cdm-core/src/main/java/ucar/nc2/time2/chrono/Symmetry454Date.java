...
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAYS_0001_TO_1970;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAYS_IN_MONTH_LONG;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAYS_IN_YEAR_LONG;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAYS_PER_CYCLE;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAY_OF_MONTH_RANGE;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.EPOCH_DAY_RANGE;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.ERA_RANGE;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.INSTANCE;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAYS_IN_MONTH;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAYS_IN_QUARTER;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAYS_IN_WEEK;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAYS_IN_YEAR;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.DAY_OF_YEAR_RANGE;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.MONTHS_IN_YEAR;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.MONTH_OF_YEAR_RANGE;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.WEEKS_IN_MONTH;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.WEEKS_IN_YEAR;
import static ucar.nc2.time2.chrono.Symmetry454Chronology.YEAR_RANGE;

/**
 * A date in the Symmetry454 calendar system.
 * <p>
 * This date operates using the {@linkplain org.threeten.extra.chrono.Symmetry454Chronology Symmetry454 calendar}.
...
public final class Symmetry454Date extends AbstractDate implements ChronoLocalDate, Serializable {
  ...
  static Symmetry454Date ofYearDay(int prolepticYear, int dayOfYear) {
    ...
    if (dayOfYear > DAYS_IN_YEAR && !leap) {
      throw new DateTimeException(
          "Invalid date 'DayOfYear " + dayOfYear + "' as '" + prolepticYear + "' is not a leap year");
    }
  ...
  static Symmetry454Date ofEpochDay(long epochDay) {
    ...
    long doy = zeroDay - (DAYS_IN_YEAR * (year - 1)
        + org.threeten.extra.chrono.Symmetry454Chronology.getLeapYearsBefore(year) * DAYS_IN_WEEK);
  ...
  public long toEpochDay() {
    long epochDay = (long) (this.prolepticYear - 1) * DAYS_IN_YEAR
        + Symmetry454Chronology.getLeapYearsBefore(this.prolepticYear) * DAYS_IN_WEEK + this.dayOfYear
        - DAYS_0001_TO_1970 - 1;
