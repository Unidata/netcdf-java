...
/**
 * CF Calendar noleap or 365_day: Gregorian calendar without leap years (all years are 365 days long).
 * LOOK: initial implemntation based on ISO8601, not Gregorian.
 * <p>
 ...
 * <li>day-of-month - There are 28 days in a standard Symmetry454 month, numbered from 1 to 28, except for the
 * middle-month
 ...
 */
public final class NoLeapChronology extends AbstractChronology implements Serializable {

  /**
   * Singleton instance for the Symmetry454 chronology.
   */
  public static final NoLeapChronology INSTANCE = new NoLeapChronology();
  /**
  ...
  static final ValueRange EPOCH_DAY_RANGE =
      ValueRange.of(-MAX_YEAR * DAYS_IN_YEAR - getLeapYearsBefore(MAX_YEAR) * DAYS_IN_WEEK - DAYS_0001_TO_1970,
