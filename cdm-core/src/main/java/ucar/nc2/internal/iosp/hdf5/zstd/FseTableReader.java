...
import static ucar.nc2.internal.iosp.hdf5.zstd.FiniteStateEntropy.MAX_SYMBOL;
import static ucar.nc2.internal.iosp.hdf5.zstd.FiniteStateEntropy.MIN_TABLE_LOG;
...
class FseTableReader {
  ...
  public int readFseTable(FiniteStateEntropy.Table table, Object inputBase, long inputAddress, long inputLimit,
    ...
    int position =
        FseCompressionTable.spreadSymbols(normalizedCounters, maxSymbol, tableSize, highThreshold, table.symbol);
