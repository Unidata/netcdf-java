 ...
 */
public class VOceanSG2 extends AbstractVerticalCTBuilder implements VerticalTransformBuilder {
  ...
  public VerticalCT.Builder<?> makeVerticalCT(NetcdfFile ds, AttributeContainer ctv) {
    ...
    VerticalCT.Builder<?> rs = VerticalCT.builder().setName("OceanSG2_Transform_" + ctv.getName())
        .setAuthority(getTransformName()).setVerticalType(VerticalCT.Type.OceanSG2).setTransformBuilder(this);
  ...
  public VerticalTransform makeMathTransform(NetcdfDataset ds, Dimension timeDim, VerticalCT vCT) {
    return OceanSG2.create(ds, timeDim, vCT.getCtvAttributes());
  }
}
