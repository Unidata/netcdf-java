...
public class VerticalTransformFactory {
  ...
  public static void registerTransform(String transformName, Class<?> c) {
    if (!(VerticalCTBuilder.class.isAssignableFrom(c)))
      throw new IllegalArgumentException("Class " + c.getName() + " must implement VertTransformBuilderIF");
   ...
   */
  @Nullable
  public static Optional<CoordinateTransform.Builder> makeVerticalTransform(NetcdfDataset ds, AttributeContainer ctv,
