...
public class ACDD {
  ...
  // suggested
  public static final String contributor_info = "contributor_info"; // The name and role of any individuals or
  ...
  public static final String coverage_content_type = "coverage_content_type"; // Information about the content of the
                                                                              // file, valid values are image,
  ...
  public static final String creator_institution_info = "creator_institution_info"; // Additional information for the
                                                                                    // institution that produced the
                                                                                    // data;
  // can include any information as ISO 19139 or free text.

  public static final String creator_project = "creator_project"; // The scientific project that produced the data;
                                                                  // should uniquely identify the project.

  public static final String creator_project_info = "creator_project_info"; // Additional information for the
                                                                            // institution that produced the data; can
                                                                            // include any information as ISO 19139 or
                                                                            // free text.

  public static final String publisher_institution = "publisher_institution"; // The institution that published the data
                                                                              // file; should uniquely identify the
                                                                              // institution.

  public static final String publisher_institution_info = "publisher_institution_info"; // Additional information for
                                                                                        // the institution that
                                                                                        // published the data; can
                                                                                        // include any information as
                                                                                        // ISO 19139 or free text.

  public static final String publisher_project = "publisher_project"; // The scientific project that published the data;
                                                                      // should uniquely identify the project.

  public static final String publisher_project_info = "publisher_project_info"; // dditional information for the
                                                                                // institution that published the data;
                                                                                // can include any information as ISO
                                                                                // 19139 or free text.
