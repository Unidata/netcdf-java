      ...
      // ======== contentPanel ========
      {
        ...
        // ======== panel1 ========
        {
          ...
          // ======== MapArePanel ========
          {
            ...
            MapArePanelLayout.setHorizontalGroup(MapArePanelLayout.createParallelGroup()
                .addGroup(MapArePanelLayout.createSequentialGroup()
                    ...
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(maxx))
                .addGroup(MapArePanelLayout.createSequentialGroup()
                    .addGroup(MapArePanelLayout.createParallelGroup()
                        .addGroup(MapArePanelLayout.createSequentialGroup().addGap(84, 84, 84).addComponent(label3))
                        .addGroup(MapArePanelLayout.createSequentialGroup().addGap(89, 89, 89).addComponent(label4)))
                    .addGap(0, 0, Short.MAX_VALUE))
                .addGroup(MapArePanelLayout.createSequentialGroup().addContainerGap()
                    .addGroup(MapArePanelLayout.createParallelGroup()
                        .addGroup(MapArePanelLayout.createSequentialGroup().addComponent(label5).addGap(18, 18, 18)
                            .addComponent(maxy).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(label6).addContainerGap())
                        .addGroup(GroupLayout.Alignment.TRAILING,
                            MapArePanelLayout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(miny, GroupLayout.PREFERRED_SIZE, 121, GroupLayout.PREFERRED_SIZE)
                                .addGap(44, 44, 44)))));
            MapArePanelLayout.setVerticalGroup(MapArePanelLayout.createParallelGroup()
                .addGroup(MapArePanelLayout.createSequentialGroup().addContainerGap()
                    .addGroup(MapArePanelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                        .addGroup(MapArePanelLayout.createParallelGroup()
                            .addGroup(MapArePanelLayout.createSequentialGroup().addComponent(label3)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(maxy,
                    ...
                    .addGroup(MapArePanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                        .addComponent(maxx, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(minx, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                            GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(miny, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE)
          ...
          panel1Layout.setHorizontalGroup(panel1Layout.createParallelGroup()
              .addGroup(GroupLayout.Alignment.TRAILING,
                  panel1Layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(applyButton)
          ...
          panel1Layout
              .setVerticalGroup(panel1Layout.createParallelGroup()
                  .addGroup(panel1Layout.createSequentialGroup().addContainerGap()
                      ...
                      .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                      .addComponent(MapArePanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                          GroupLayout.PREFERRED_SIZE)
                      .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 72, Short.MAX_VALUE)
                      .addGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                          .addComponent(cancelButton).addComponent(okButton).addComponent(applyButton))
                      .addContainerGap()));
        }
