...
/** Interacts with code generated by jformdesigner. */
public class NetcdfOutputChooser extends JDialog {
  ...
  public void setOutputFilename(String filename) {
    ...
    String suffix = (version == NetcdfFileFormat.NETCDF4) ? ".nc4" : ".nc";
  ...
  private void initComponents() {
    ...
    label2 = new JLabel();
    netcdfVersion = new JComboBox(NetcdfFileFormat.values());
    panel1 = new JPanel();
    label3 = new JLabel();
