...
public class CsmSigma extends AbstractTransformBuilder implements VertTransformBuilderIF {
  ...
  /**
   * Add a Parameter to a CoordinateTransform. The variable attribute points to a another variable that has the data in it. Make sure that
   * attribute and variable exist. If readData is true, read the data and use it as the value of the parameter, otherwise use the name as
