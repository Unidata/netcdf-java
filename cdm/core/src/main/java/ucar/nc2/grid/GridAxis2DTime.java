 ...
 * NOT DONE YET
 */
public class GridAxis2DTime extends GridAxis {
  ...
  protected GridAxis2DTime(Builder<?> builder) {
    super(builder);
  ...
  public static abstract class Builder<T extends GridAxis2DTime.Builder<T>> extends GridAxis.Builder<T> {
    ...
    public GridAxis2DTime build() {
      ...
      return new GridAxis2DTime(this);
    }
  }
