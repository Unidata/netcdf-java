...
public class TestStructurePseudoDSBuilder {
  ...
  public void testBuilder() {
    ...
    StructurePseudoDS struct =
        StructurePseudoDS.builder().setName("name").setDataType(DataType.FLOAT).addMemberVariable(var)
  ...
  public void testBuilderChain() {
    StructurePseudoDS struct =
        StructurePseudoDS.builder().setName("struct").addMemberVariables(ImmutableList.of())
            .setGroup(makeDummyGroup()).build();
    assertThat(struct.getDataType()).isEqualTo(DataType.STRUCTURE);
  ...
  public void testToBuilderChain() {
    Variable.Builder var = Variable.builder().setName("member").setDataType(DataType.FLOAT)
        .setGroup(makeDummyGroup());
    StructurePseudoDS struct =
        StructurePseudoDS.builder().setName("name").setUnits("units").addMemberVariable(var)
            .setGroup(makeDummyGroup()).build();
