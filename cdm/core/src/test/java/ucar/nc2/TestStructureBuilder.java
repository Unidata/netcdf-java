...
public class TestStructureBuilder {
  ...
  public void testBuilder() {
    ...
    Structure struct = Structure.builder().setName("name").setDataType(DataType.FLOAT)
        .setGroup(makeDummyGroup()).addMemberVariable(var).build();
  ...
  public void testBuilderChain() {
    Structure struct = Structure.builder().setName("struct").addMemberVariables(ImmutableList.of())
  ...
  public void testToBuilderChain() {
    Variable.Builder var = Variable.builder().setName("member")
        .setGroup(makeDummyGroup()).setDataType(DataType.FLOAT);
    Structure struct = Structure.builder().setName("name").setDataType(DataType.FLOAT)
        .setGroup(makeDummyGroup()).addMemberVariable(var).build();
