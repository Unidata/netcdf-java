...
public abstract class AbstractLightningIOSP extends AbstractIOServiceProvider {
   ...
   * @return the variable
   */
  protected Variable makeLightningVariable(NetcdfFile ncfile, Group group, Structure seq, String name,
      DataType dataType, String dims, String longName, String cfName, String units, AxisType type) {
    ...
    if (type != null) {
      v.addAttribute(new Attribute(_Coordinate.AxisType, type.toString()));
    }
    return v;
  }
