...
public class TestSimpleGeometryReader {
  ...
  public void testReaderPoint() throws IOException {
    ...
    // Test point data
    Assert.assertEquals(-91.277, point0.getX(), 0.0001);
    Assert.assertEquals(40.75365, point0.getY(), 0.000001);
    Assert.assertEquals(-91.674, point1.getX(), 0.0003);
    Assert.assertEquals(40.9253, point1.getY(), 0.00001);
    Assert.assertEquals(-91.5515, point2.getX(), 0.00006);
    Assert.assertEquals(41, point2.getY(), 0.1);
