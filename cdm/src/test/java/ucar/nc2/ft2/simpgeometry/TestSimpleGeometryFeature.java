...
public class TestSimpleGeometryFeature {
  ...
  public void testSetCoordSysNull() {
    SimpleGeometryFeature cov =
        new SimpleGeometryFeature(name, dt, att, coordSysName, units, description, user, geometry);
  ...
  public void testReadPolygon() throws IOException, InvalidRangeException {
    ...
    SimpleGeometryFeature cov =
        new SimpleGeometryFeature(name, dt, att, coordSysName, units, description, user, POLYGON);
    cov.setCoordSys(cs);
