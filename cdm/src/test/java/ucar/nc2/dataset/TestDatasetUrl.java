...
public class TestDatasetUrl {
  ...
  public void testGetProtocols() {
    ...
    protocheck("dynamic:http://thredds.ucar.edu:8080/thredds/fmrc/NCEP/GFS/CONUS_95km/files/GFS_CONUS_95km_20070319_0600.grib1", "dynamic:http:");
  }
  ...
  public void problem() throws IOException {
    testFind("dynamic:http://thredds.ucar.edu:8080/thredds/fmrc/NCEP/GFS/CONUS_95km/files/GFS_CONUS_95km_20070319_0600.grib1", null);
  }
  ...
  public void testFindDatasetUrl() throws IOException {
    ...
    testFind("thredds:file:c:/dev/netcdf-java-2.2/test/data/catalog/addeStationDataset.xml#AddeSurfaceData", ServiceType.THREDDS);
    ...
    testFind("dap4:http://thredds.ucar.edu:8080/thredds/fmrc/NCEP/GFS/CONUS_95km/files/GFS_CONUS_95km_20070319_0600.grib1", ServiceType.DAP4);
