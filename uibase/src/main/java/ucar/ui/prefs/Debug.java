 ...
 *
 * <p>
 * To use, make sure that you call setStore() before anything else; it is a
 ...
 * 
 * <p>
 * To allow user control at runtime, add a JMenu instance variable to your main menu,
 ...
 *
 * <p>
 * The first time this code is called, this flag will be added to the Store and
...
public class Debug {
  ...
  private static class DebugMenuItem extends JCheckBoxMenuItem {
    ...
    DebugMenuItem(String foolName, String menuName, boolean val) {
      ...
      addChangeListener(e -> {
        if (debugEvents) {
          System.out.println("DebugMenuItem " + getText() + " " + getState());
        }
